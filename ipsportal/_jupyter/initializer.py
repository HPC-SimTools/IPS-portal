...
To understand how the API works, you can inspect the 'ips_api_{CURRENT_API_VERSION}.py' directly by going up one directory from where this notebook is located.
