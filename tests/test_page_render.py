...
def test_post_event(client):
    ...
    response = client.post(
        ...
        json={
            ...
            'trace': {
                ...
                'duration': 2153081,
                'localEndpoint': {'serviceName': '/bin/sleep'},
                'name': '2.0',
                'id': '8a064c788269e0b1',
                'parentId': '4f44682177c5b766',
                'tags': {'procs_requested': '1', 'cores_allocated': '1'},
                'traceId': traceID,
            },
            'state': 'Running',
    ...
    response = client.post(
        ...
        json={
            ...
            'trace': {
                ...
                'duration': 26499127,
                'localEndpoint': {'serviceName': 'sim@driver@2'},
                'name': 'step(0)',
                'id': '4f44682177c5b766',
    ...
    response = client.post(
        ...
        json={
            ...
            'trace': {
                ...
                'duration': 26995801,
                'localEndpoint': {'serviceName': 'FRAMEWORK@Framework@0'},
                'id': 'f3994d99c2892c58',
                'tags': {'total_cores': '8'},
                'traceId': traceID,
            },
    ...
    assert response.status_code == 200
    assert (
        f"<a href='/{runid}'>Run - {runid}</a> Sim Name: CI Test Comment: "
    ...
    r = requests.get(
        f'http://{os.environ.get("JAEGER_HOST", "localhost")}:16686/jaeger/api/traces/{traceID}', timeout=10
    )
    ...
    os.system('docker container restart jaeger')  # noqa: S605, S607
    time.sleep(1)
